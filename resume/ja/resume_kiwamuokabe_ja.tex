...
\subsubsection*{2010年04月: 新規IntelアーキティクチャへのOSポーティング (リーダー)}
古いIntelボードが生産寿命を迎えたため、新規IntelボードへのNetBSD-2.0\footnote{\href{http://netbsd.org/}{\tt http://netbsd.org/}}移植。またBIOSメーカ選定/委託締結。
...
これまで古いユーザ空間スレッド(pthread互換)で構築されていたコピー機のシステムをNetBSD-2.0標準のm:nスレッドで再構築した。
...
\subsubsection*{2001年07月: 社内初のIntelアーキティクチャコピー機のBIOS/bootloader開発 (主担当)}
それまでmipsアーキティクチャを採用していたコピー機をIntelアーキティクチャを用いて開発するプロジェクトに新人として配属。
開発した製品はimagioシリーズ\footnote{\href{http://www.ricoh.co.jp/imagio/}{\tt http://www.ricoh.co.jp/imagio/}}として現在も出荷され続けている。
また現在出荷されているIntel CPUを用いたリコー製のコピー機とプリンタは、新人時代に設計したBIOSとbootloaderの基本設計をそのまま引き継いでいる。
