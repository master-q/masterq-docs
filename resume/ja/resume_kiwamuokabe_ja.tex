...
%%%%%%%%%%%%%%%%
\subsection*{2023年02月 - 現在: ヴィーエー・リナックス・システムズ・ジャパン株式会社にてソフトウェアエンジニア(正社員)}

\noindent Responsibilities:

\begin{itemize}
  \item Data Plane Development Kit\footnote{\href{https://www.dpdk.org/}{\tt https://www.dpdk.org/}}の開発と顧客サポート
\end{itemize}
