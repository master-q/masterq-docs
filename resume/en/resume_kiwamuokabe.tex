...
\begin{itemize}
  \item Languages: C, Haskell, Intel/ARM assembler, Ruby, C++, PHP, OCaml, SQL, Python, Erlang, JavaScript, R, Kotlin, Go
  \item Platforms: Linux, NetBSD, Cygwin, FreeRTOS, ChibiOS/RT, Android NDK, MinGW, Yocto
  \item Database: MySQL
\end{itemize}
...
\begin{itemize}
  \item Verified Linux kernel with Infer static analyzer\footnote{\url{https://valinux-hatenablog-com.translate.goog/entry/20230803?_x_tr_sl=auto&_x_tr_tl=en}}
\end{itemize}
