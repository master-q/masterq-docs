...
\subsection*{Good documentation writer}

I have some experiences to write formal academic papers. And also I have translated many English documents about open-source software into Japanese \footnote{\href{http://jats-ug.metasepi.org/}{\tt http://jats-ug.metasepi.org/}}\footnote{\href{https://github.com/jverifast-ug/translate}{\tt https://github.com/jverifast-ug/translate}}\footnote{\href{http://fstar-ja.metasepi.org/}{\tt http://fstar-ja.metasepi.org/}}. And I have used translation tools such as gettext\footnote{\href{https://www.gnu.org/software/gettext/gettext.html}{\tt https://www.gnu.org/software/gettext/gettext.html}} or po4a\footnote{\href{https://po4a.org/}{\tt https://po4a.org/}} to maintain my translations.
...
%%%%%%%%%%%%%%%%
\subsection*{October 2019 - Present: Software Engineer (trustee agreement) at QuantumCore CORPORATION}
