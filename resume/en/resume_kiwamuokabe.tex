...
\begin{itemize}
  \item Languages: C (12 years), Haskell (5 years), Intel/ARM assembler (5 years), Ruby (5 years), C++ (3 years), PHP (2 years), SQL (1.5 years), OCaml (2 years), Python (1 year), Erlang (1 year), JavaScript (1 year), R (1 year), Go (0.5 years)
  \item Platforms: Linux (15 years), NetBSD (12 years), Cygwin (2 years), FreeRTOS (1.5 years), ChibiOS/RT (1.5 years), Android NDK (1 year), MinGW (1 year)
...
%%%%%%%%%%%%%%%%
\subsection*{December 2020 - Present: Software Engineer (permanent employee) at Donuts Co. Ltd.}

\noindent Responsibilities:

\begin{itemize}
  \item Maintaining an ERP web application using PHP, Zend Framework, JavaScript, MySQL, and AWS
\end{itemize}
