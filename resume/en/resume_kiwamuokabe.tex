...
%%%%%%%%%%%%%%%%
\subsection*{February 2023 - Present: Software Engineer (permanent employee) at VA Linux Systems Japan K.K.}

\noindent Responsibilities:

\begin{itemize}
  \item Development and customer support of Data Plane Development Kit\footnote{\href{https://www.dpdk.org/}{\tt https://www.dpdk.org/}}
\end{itemize}
