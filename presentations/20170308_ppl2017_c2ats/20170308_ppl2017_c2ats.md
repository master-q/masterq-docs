...
%}
fun take_struct_c2ats_t2_tp: {l1:agz} (!ptr_v_1(struct_c2ats_t2, l1) | ptr l1) -> [l2:addr] (ptr_v_1(struct_c2ats_t1, l2), ptr_v_1(struct_c2ats_t1, l2) -<lin,prf> void | ptr l2) = "mac#"
```
